...
media = np.mean(precos_array_final)
mediana = np.median(precos_array_final)
...
# # #Calcule a distancia entre a media e a mediana:
# distancia = (media - mediana) / mediana
# print(f"Distancia entre a média e a mediana:{distancia * 100:.2f}%")
